...
const Banner = () => {
    return (
    <div className="bg-base-200 max-w-5xl mx-auto rounded-2xl mt-10 mb-14 pb-12 pt-12">
    ...
    <div>
      ...
      <button className="btn rounded-xl text-white bg-[#23BE0A]">View The List</button>
    </div>
  </div>
</div>
    );
